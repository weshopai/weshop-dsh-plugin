...
`;
		...
		function WeshopWorkspace({ onExit, onSelectionChange, embedded = false, initialActionCursor = Date.now() }) {
		...
		function CanvasChat({ session, sessionTitle, selection = [], onExit }) {
