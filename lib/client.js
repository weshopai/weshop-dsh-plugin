window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const c$1 = react.forwardRef((o, r) => /* @__PURE__ */ react.createElement(p, {
			ref: r,
			...o,
			weights: a$8
		}));
...
`;
		...
		function WeshopWorkspace({ onExit, embedded = false, initialActionCursor = Date.now() }) {
			...
			const beginCanvasGesture = (event) => {
				...
				if (event.button === 1 || spacePressed.current) gesture.current = {
					type: "pan",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(s$3, { size: 13 })
									}),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
										...
										title: "配置 WeShop API Key",
										children: [
											apiConfig?.configured ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(s$2, {
												size: 17,
												weight: "fill"
											}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(n$5, { size: 17 }),
											" ",
											apiConfig?.configured ? "API 已配置" : "配置 API Key"
										]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
											...
											children: [
												...
												" Add ",
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)(s$3, { size: 11 })
											]
					...
					apiDialogOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("form", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", { children: "连接 WeShop" }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: "密钥只保存在这台电脑的 Harness 主机中，不会写入画布、对话或浏览器存储。" }),
								apiConfig?.configured && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "api-key-status",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(s$2, {
										size: 16,
										weight: "fill"
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: ["当前已配置 · ", apiConfig.source === "canvas" ? "画布私密存储" : apiConfig.source === "plugin" ? "插件设置" : "环境变量"] })]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "API Key" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									...
									placeholder: apiConfig?.configured ? "输入新密钥以替换当前配置" : "粘贴 WeShop API Key"
								})] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
									href: "https://open.weshop.ai/authorization/apikey",
									target: "_blank",
									rel: "noreferrer",
									children: "获取 WeShop API Key ↗"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "dialog-actions",
									children: [
					...
					!embedded && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(s$3, { size: 0 }), "← Back to DSH"]
					}),
					"    ",
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
						ref: fileRef,
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
									...
									"aria-label": "发送消息",
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(s$4, {
										size: 16,
										weight: "bold"
									})
								})]
