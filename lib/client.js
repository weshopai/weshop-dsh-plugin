...
`;
		...
		const dictionaries = {
			...
			en: {
				...
				"打开 DSH 设置 → 插件 → WeShop，填写 API Key 后即可生成。也可以在启动 Harness 前设置 WESHOP_API_KEY。": "Open DSH Settings → Plugins → WeShop and enter an API Key, or set WESHOP_API_KEY before starting Harness.",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							apiConfig?.configured === false && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								role: "status",
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("需要配置 WeShop API Key") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: t("打开 DSH 设置 → 插件 → WeShop，填写 API Key 后即可生成。也可以在启动 Harness 前设置 WESHOP_API_KEY。") })]
							}),
